...
<nav class="bg-blue-600 p-4 text-white">
  <div class="container mx-auto flex justify-between items-center">
    ...
    <div class="md:hidden flex items-center">
      <button on:click={toggleMobileNav} class="text-white">☰</button>
    </div>
  </div>
  <!-- Mobile Nav Menu -->
  {#if showMobileNav}
    <div class="w-full bg-blue-500">
      <ul class="flex flex-col space-y-2 py-2">
        <li>
          <a href="#home" class="block px-4 py-2 hover:underline">Home</a>
        </li>
        <li>
        ...
        <li>
          <a href="#privacy-policy" class="block px-4 py-2 hover:underline"
            >Privacy Policy</a
          >
        </li>
        <li>
          <a href="#login" class="block px-4 py-2 hover:underline">Login</a>
        </li>
      </ul>
    </div>
  {/if}
